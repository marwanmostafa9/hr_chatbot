...
# installed.
TCL_PREFIX='D:/LangChain/Self Trial/project_test1/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/LangChain/Self Trial/project_test1/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/LangChain/Self Trial/project_test1/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/LangChain/Self Trial/project_test1/venv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/LangChain/Self Trial/project_test1/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/LangChain/Self Trial/project_test1/venv\Library\lib\tclstub86.lib'
